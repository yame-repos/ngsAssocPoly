                                  ...
                                  read.err.prob = 0.001)
{
  ...
  for (p in 1:n.markers) {
    print(paste("Calculating allelic dosage probability:  ",
                p, "/", n.markers, "completed"))
    M = M.geno
  ...
  rm(rd, dp, M, M.geno, geno.prob, prob, prob.vec, n.markers, n.samples, sample.names, round.up, cut.off, n, r, i, j, p)
  gc()
